...
from .views import UserListCreateView, HotelListCreateView, RoomListCreateView, BookingListCreateView, UserDetailView, HotelDetailView, BookingDetailView, RoomDetailView, ChangePasswordView
